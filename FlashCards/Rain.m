...
-(void) didMoveToView:(SKView *)view{
    ...
    _img.image = [UIImage imageNamed:@"Rain.png"];
    _img.hidden = NO;
    ...
    //Create raining, sunny and lightning
    ...
    rainNode.position = CGPointMake(300, 50);
...
-(void)touchesBegan:(NSSet *)touches withEvent:(UIEvent *)event { //if happy Node pressed (matches scene, move onto next scene
    ...
    for(UITouch *touch in touches){
        ...
        if([rainNode containsPoint:rainLocation]){
            //create actions
            ...
            [UIImageView animateWithDuration:0.5f
                                  ...
                                  completion:^(BOOL finished) {
                                      ...
                                      [rainNode runAction:moveSequence completion:^{
                                          switch (randNum) {
                                              case 1:
