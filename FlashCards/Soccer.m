...
-(void) didMoveToView:(SKView *)view{
    ...
    _img.image = [UIImage imageNamed:@"Soccer.png"];
    _img.hidden = NO;
    ...
    //Create bball, soccer, and tenis nodes
    ...
    soccerNode.position = CGPointMake(300, 50);
    ...
    basketballNode.text = @"Basetball";
    basketballNode.name = @"basketballNode";
    basketballNode.fontSize = 18;
    basketballNode.position = CGPointMake(700, 50);
...
-(void)touchesBegan:(NSSet *)touches withEvent:(UIEvent *)event { //if happy Node pressed (matches scene, move onto next scene
    ...
    for(UITouch *touch in touches){
        ...
        if([soccerNode containsPoint:soccerLocation]){
            //create actions
            ...
            [UIImageView animateWithDuration:0.5f
                                  ...
                                  completion:^(BOOL finished) {
                                      ...
                                      [soccerNode runAction:moveSequence completion:^{
                                          switch (randNum) {
                                              case 1:
