...
-(void) didMoveToView:(SKView *)view{
    ...
    _img.image = [UIImage imageNamed:@"Basketball.png"];
    _img.hidden = NO;
    ...
    //Create basketball, tennis, and soccer nodes
    ...
    basketballNode.position = CGPointMake(300, 50);
    ...
    tennisNode.position = CGPointMake(CGRectGetMidX(self.frame), 50);
...
-(void)touchesBegan:(NSSet *)touches withEvent:(UIEvent *)event { //if happy Node pressed (matches scene, move onto next scene
    ...
    for(UITouch *touch in touches){
        ...
        if([basketballNode containsPoint:basketballLocation]){
            //create actions
            ...
            [UIImageView animateWithDuration:0.5f
                                  ...
                                  completion:^(BOOL finished) {
                                      ...
                                      [basketballNode runAction:moveSequence completion:^{
                                          switch (randNum) {
                                              case 1:
        ...
        if ([tennisNode containsPoint:tennisLocation]){ //wrong location
            //create actions
            SKAction *shrink = [SKAction scaleTo:0.5 duration:0.05];
            [tennisNode runAction:shrink];
        }
